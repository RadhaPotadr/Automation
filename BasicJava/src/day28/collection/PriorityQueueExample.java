...
public class PriorityQueueExample {
	public static void main(String args[]) {
		...
		// while adding element in Queue, it will always 
		//keep smallest element on the top
		queue.add(123);
		queue.add(245);
		queue.add(10);
		queue.add(105);
		...
		System.out.println("Eleements of Queue: " + queue);
		 //element() returns top most element of the queue,
		//if the queue if empty dn it
		...
		// peek() returns top most element of the queue, 
		//if the queue if empty dn it
		...
		System.out.println("Eleements of Queue: " + queue);
		// remove():it will remove top most element of the Queue,
		//if the queue is empty dn it
		// will throw an exception by name 'NoSuchElementException'
		System.out.println("removing element from Queue using remove(): " + queue.remove());// 10
		System.out.println("Eleements of Queue: " + queue);
		// poll():it will remove top most element of the Queue, 
		//if the queue is empty dn it
