...
public class PIM extends SeleniumUtility {
	WebDriver driver;
	Actions act;
	List<WebElement> emp;
	...
	public void testPIMCreate() throws InterruptedException {
		...
		WebElement id = driver.findElement(
				By.cssSelector(".orangehrm-employee-form>div>div:nth-of-type(2)>div>div>div:nth-of-type(2)>input"));
		...
		Thread.sleep(2000);
		System.out.println("PIM creation validation :" + (!driver
				.findElement(By.xpath("//span[(text()='(1) Record Found')]")).getText().equals("No Records Found")));
	...
	@Test(priority=2)
	public void testPIMModify() throws InterruptedException {
		driver.findElement(By.cssSelector(".orangehrm-container>div>div:nth-of-type(2) span>i")).click();
		driver.findElement(By.cssSelector(
				".orangehrm-container>div>div:nth-of-type(2) >div>div>div:nth-of-type(9)>div button:nth-of-type(2)>i"))
				.click();
	...
	public void testPIMDelete() throws InterruptedException {
		driver.findElement(By.cssSelector(".orangehrm-container>div>div:nth-of-type(2) span>i")).click();
		driver.findElement(By.cssSelector(
				".orangehrm-container>div>div:nth-of-type(2) >div>div>div:nth-of-type(9)>div button:nth-of-type(1)>i"))
				.click();
