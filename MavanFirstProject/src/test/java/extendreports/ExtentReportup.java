...
public class ExtentReportup{
	ExtentReports report;
	ExtentTest test;
	@BeforeTest
	public void startReport(){
		report = new ExtentReports (".\\extentreports\\ExtentReportup.html", true);
		//extent.addSystemInfo("Environment","Environment Name")
		report
                .addSystemInfo("Host Name", "Radha")
                .addSystemInfo("Environment", "QA")
                .addSystemInfo("User Name", "Radha Potdar");
